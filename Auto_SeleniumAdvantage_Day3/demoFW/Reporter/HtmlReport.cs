...
namespace CoreFramework.Reporter
{
    ...
    {       
        ...
        public static void MarkUpHtml()
           {
               ...
               var mark = MarkupHelper.CreateLabel((string)htmlMarkup, ExtentColor.Transparent);
               GetTest().Info(mark);
           }

        public static void MarkupTable()
        {
            string[][] someInts = new string[][] { new string[] { "<label> youtube </label>" } };
            var mark = MarkupHelper.CreateTable(someInts);
            GetTest().Info(mark);
        }
        ...
        {
            var text = "Passed";
            var mark = MarkupHelper.CreateLabel(text, ExtentColor.Green);
            GetTest().Pass(mark);
        }
        ...
        {
            var text = "Failed";
            var mark = MarkupHelper.CreateLabel(text, ExtentColor.Red);
            GetTest().Pass(mark);
        }
        ...
        {
            var text = "Skipped";
            var mark = MarkupHelper.CreateLabel(text, ExtentColor.Blue);
            GetTest().Pass(mark);
        }

        public static void CreateAPIRequestLog(APIRequest aPIRequest, APIResponse response)
        {
            GetTest().Info(MarkupHelperPlus.CreateAPIRequestLog(aPIRequest, response));
        }
    }
}
